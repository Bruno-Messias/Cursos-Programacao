...
class GNU_Tutorial(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "RTTY reciever")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("RTTY reciever")
        ...
        self.settings = Qt.QSettings("GNU Radio", "GNU_Tutorial")
        ...
        # Variables
        ##################################################
        self.transition_bw = transition_bw = 0
        ...
        self._reverse_labels = ('Reverse', 'Normal', )
        # Create the combo box
        self._reverse_tool_bar = Qt.QToolBar(self)
        self._reverse_tool_bar.addWidget(Qt.QLabel('reverse' + ": "))
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_fcf(50, , 2.21k, samp_rate)
        self.digital_binary_slicer_fb_0 = digital.binary_slicer_fb()
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(reverse)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.audio_source_0 = audio.source(48000, 'Microphone', True)
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf(128.177k)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center, self.samp_rate/50)
...
def main(top_block_cls=GNU_Tutorial, options=None):
