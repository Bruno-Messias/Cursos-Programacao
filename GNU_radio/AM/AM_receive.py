...
class AM_receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "AM Reciever")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM Reciever")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, int(self.samp_rate/self.decim), 500, 6000, 400, firdes.WIN_HAMMING, 6.76))
