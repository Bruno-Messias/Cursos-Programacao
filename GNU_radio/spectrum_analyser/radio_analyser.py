...
class radio_analyser(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Spectrum Analyser")
        ...
        self.settings = Qt.QSettings("GNU Radio", "radio_analyser")
...
def main(top_block_cls=radio_analyser, options=None):
